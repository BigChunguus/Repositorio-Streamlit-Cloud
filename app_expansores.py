# https://app-dashboard-6zuyxkuotnlqmyefgrxfcp.streamlit.app/
...
# 📌 USO DE EXPANSORES
with st.expander("📊 Ver Ventas Mensuales"):
...
with st.expander("📈 Ver Rendimiento de Empleados"):
...
with st.expander("🌍 Ver Distribución Geográfica de Clientes"):
